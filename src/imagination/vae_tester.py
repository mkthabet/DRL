...
decoder = load_model('models/decoder_01.h5')
encoder = load_model('models/encoder_01.h5')
#vae = load_model('models/vae_01.h5')
...
for i, yi in enumerate(grid_x):
    for j, xi in enumerate(grid_y):
        ...
        b, g, r = cv2.split(digit)
        digit = cv2.merge([r, g, b])
        #print(np.max(digit))
