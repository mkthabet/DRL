...
NUM_STATE = env_test.env.getStateSpaceSize()
NUM_ACTIONS = actionCnt = env_test.env.getActSpaceSize()
NONE_STATE = np.zeros(NUM_STATE)

brain = Brain()	# brain is global in A3C

envs = [Environment(eps_start = random.random()) for i in range(THREADS)]
