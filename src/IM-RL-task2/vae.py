...
def train_vae():
    for latent_dim in (64, 8):
        for BETA in (1, 2, 4, 8):
            ...
            decoded_mean = Conv2DTranspose(1, (6, 6), strides=(2, 2), activation='sigmoid')(deconv)
            ...
            x_train = y_train = x_test = y_test = getImages(return_single=True, use_all=True, val=False)
            ...
            try:
                ...
                encoder.save(('models/encoder_000') + str(latent_dim) + '_' + str(BETA) + '.h5')
                decoder.save(('models/decoder_000') + str(latent_dim) + '_' + str(BETA) + '.h5')
                vae.save(('models/vae_000') + str(latent_dim) + '_' + str(BETA) + '.h5')
#
#
# n = 15
# digit_size = IMAGE_HEIGHT
